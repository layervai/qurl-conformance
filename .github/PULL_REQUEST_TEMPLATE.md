...
- [ ] Consumers verified against these vectors (qurl-go, the NHP implementation, and qurl-typescript run this in their own CI; a protocol change lands here first and consumers adopt after release)
