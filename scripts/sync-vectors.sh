...
for f in qv2_conformance_vectors.json issuer_signature_vectors.json relay_knock_golden.json agent_registration_golden.json agent_knock_application_vectors.json agent_api_key_id_vectors.json; do
